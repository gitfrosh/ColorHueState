...
string memory html = string(
    abi.encodePacked('<?xml version=\'1.0\' encoding=\'UTF-8\'?><svg xmlns=\'http://www.w3.org/2000/svg\' height=\'800\' width=\'800\'>')
);
...
for (uint256 i = 0; i < 4; i++) {
    ...
    html = string(
        abi.encodePacked(
            ...
            ' <stop offset=\'',
            Strings.toString(ps[i]),'%\' style=\'stop-color:',start,';stop-opacity:1\'></stop>',
